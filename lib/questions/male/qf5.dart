...
import 'package:chulada_form_page/questions/male/qf6.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class QuestionFemale55 extends StatefulWidget {
  const QuestionFemale55({super.key});

  @override
  State<QuestionFemale55> createState() => _QuestionFemale55State();
}

class _QuestionFemale55State extends State<QuestionFemale55> {
  ...
  ElevatedButton BotonWidget1() {
    return ElevatedButton(
      onHover: (value) {
        if (value) {
          setState(() {
            opcionSeleccionado1 = Colors.orange.shade500;
      ...
      onPressed: () {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => const QuestionFemale66()),
        );
      },
  ...
  ElevatedButton BotonWidget2() {
    return ElevatedButton(
      onHover: (value) {
        if (value) {
          setState(() {
            opcionSeleccionado2 = Colors.orange.shade500;
            colorTexto = Colors.white;
          });
        } else {
          setState(() {
  ...
  ElevatedButton BotonWidget3() {
    return ElevatedButton(
      onHover: (value) {
        if (value) {
          setState(() {
            opcionSeleccionado3 = Colors.orange.shade500;
            colorTexto = Colors.white;
          });
        } else {
          setState(() {
