...
import 'package:chulada_form_page/questions/male/qf4.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:page_transition/page_transition.dart';

class QuestionFemale33 extends StatefulWidget {
  const QuestionFemale33({super.key});

  @override
  State<QuestionFemale33> createState() => _QuestionFemale33State();
}

class _QuestionFemale33State extends State<QuestionFemale33> {
  ...
  ElevatedButton BotonWidget1() {
    return ElevatedButton(
      onHover: (value) {
        if (value) {
          setState(() {
            opcionSeleccionado1 = Colors.pink.shade500;
  ...
  ElevatedButton BotonWidget2() {
    return ElevatedButton(
      onHover: (value) {
        if (value) {
          setState(() {
            opcionSeleccionado2 = Colors.pink.shade500;
            colorTexto = Colors.white;
          });
        } else {
          setState(() {
  ...
  ElevatedButton BotonWidget3() {
    return ElevatedButton(
      onHover: (value) {
        if (value) {
          setState(() {
            opcionSeleccionado3 = Colors.pink.shade500;
            colorTexto = Colors.white;
          });
        } else {
          setState(() {
