...
import 'package:chulada_form_page/questions/male/qf7.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class QuestionFemale66 extends StatefulWidget {
  const QuestionFemale66({super.key});

  @override
  State<QuestionFemale66> createState() => _QuestionFemale66State();
}

class _QuestionFemale66State extends State<QuestionFemale66> {
    ...
    return ElevatedButton(
      ...
      onPressed: () {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => const QuestionFemale77()),
        );
      },
