...
import 'package:chulada_form_page/questions/male/qf8.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class QuestionFemale77 extends StatefulWidget {
  const QuestionFemale77({super.key});

  @override
  State<QuestionFemale77> createState() => _QuestionFemale77State();
}

class _QuestionFemale77State extends State<QuestionFemale77> {
  ...
  ElevatedButton BotonWidget1() {
    return ElevatedButton(
      onHover: (value) {
        if (value) {
          setState(() {
            opcionSeleccionado1 = Colors.purple.shade500;
      ...
      onPressed: () {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => const QuestionFemale88()),
        );
      },
  ...
  ElevatedButton BotonWidget2() {
    return ElevatedButton(
      onHover: (value) {
        if (value) {
          setState(() {
            opcionSeleccionado2 = Colors.purple.shade500;
            colorTexto = Colors.white;
          });
        } else {
          setState(() {
  ...
  ElevatedButton BotonWidget3() {
    return ElevatedButton(
      onHover: (value) {
        if (value) {
          setState(() {
            opcionSeleccionado3 = Colors.purple.shade500;
            colorTexto = Colors.white;
          });
        } else {
          setState(() {
