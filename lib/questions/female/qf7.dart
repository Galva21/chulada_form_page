...
import 'package:chulada_form_page/questions/female/qf8.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class QuestionFemale7 extends StatefulWidget {
  const QuestionFemale7({super.key});

  @override
  State<QuestionFemale7> createState() => _QuestionFemale7State();
}

class _QuestionFemale7State extends State<QuestionFemale7> {
    ...
    return ElevatedButton(
      ...
      onPressed: () {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => const QuestionFemale8()),
        );
      },
