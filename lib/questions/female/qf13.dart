...
import 'package:chulada_form_page/questions/female/qf14.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class QuestionFemale13 extends StatefulWidget {
  const QuestionFemale13({super.key});

  @override
  State<QuestionFemale13> createState() => _QuestionFemale13State();
}

class _QuestionFemale13State extends State<QuestionFemale13> {
    ...
    return ElevatedButton(
      ...
      onPressed: () {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => const QuestionFemale14()),
        );
      },
