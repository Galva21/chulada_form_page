...
import 'package:chulada_form_page/questions/female/qf6.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class QuestionFemale5 extends StatefulWidget {
  const QuestionFemale5({super.key});

  @override
  State<QuestionFemale5> createState() => _QuestionFemale5State();
}

class _QuestionFemale5State extends State<QuestionFemale5> {
    ...
    return ElevatedButton(
      ...
      onPressed: () {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => const QuestionFemale6()),
        );
      },
