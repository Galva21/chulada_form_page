...
import 'package:chulada_form_page/questions/female/qf13.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class QuestionFemale12 extends StatefulWidget {
  const QuestionFemale12({super.key});

  @override
  State<QuestionFemale12> createState() => _QuestionFemale12State();
}

class _QuestionFemale12State extends State<QuestionFemale12> {
    ...
    return ElevatedButton(
      ...
      onPressed: () {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => const QuestionFemale13()),
        );
      },
