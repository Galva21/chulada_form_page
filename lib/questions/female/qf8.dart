...
import 'package:chulada_form_page/questions/female/qf9.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class QuestionFemale8 extends StatefulWidget {
  const QuestionFemale8({super.key});

  @override
  State<QuestionFemale8> createState() => _QuestionFemale8State();
}

class _QuestionFemale8State extends State<QuestionFemale8> {
    ...
    return ElevatedButton(
      ...
      onPressed: () {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (context) => const QuestionFemale9()),
        );
      },
